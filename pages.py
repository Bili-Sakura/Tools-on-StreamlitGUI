...
def chat_llm_page():
    ...
    if not api_key:
        st.warning("⚠️ DASHSCOPE_API_KEY environment variable is not set. Please configure your API key to use this feature.")
        st.info("To use this feature in Streamlit Cloud, add your API key in the app's secrets management.")
        return
